...
(function() {
  ...
  (function($, window) {
    ...
    chardinJs = (function() {
      ...
      chardinJs.prototype._can_create = function(element) {
        return element.getAttribute('chardin-show') || 'false';
      };
      ...
      chardinJs.prototype._show_element = function(element) {
        if ((this._can_create(element)) === 'true') {
          ...
          helper_layer.className = "chardinjs-helper-layer chardinjs-" + (this._get_position(element)) + " hidden-xs hidden-sm";
